        ...
        <center>
           <table align="center" border="1" cellpadding="3" cellspacing="0" width="100%" id="tabel">
            ...
            <?php for ($i=1; $i<=$pages ; $i++){ ?>  <div class="pagging"><a href="index.php?aksi=laporan-kas-keluar&halaman=<?php echo $i; ?>"><?php echo $i; ?></a></div><?php } ?>&nbsp 
        </center>
        <a href="convert-kas-keluar.php"><button id="tombol-sedang-kanan">Convert</button></a>
